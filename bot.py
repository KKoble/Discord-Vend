...
EMOJI_NOTICE  = discord.PartialEmoji(name="Announce", id=이모지ID 넣어주세요)
EMOJI_PRODUCT = discord.PartialEmoji(name="Product",  id=이모지ID 넣어주세요)
EMOJI_BUY     = discord.PartialEmoji(name="Buy",      id=이모지ID 넣어주세요)
